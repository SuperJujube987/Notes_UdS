...
\fancyfoot{}
\fancyhead{}
\fancyfoot[l]{MAT141 - \'El\'ements d'alg\`ebre}
\fancyfoot[r]{\thepage}
...
\begin{document}
	...
	\begin{exem}
		...
		\begin{align*}
			...
			\begin{split}
				...
				&= 2
			\end{split}\tag{8}
		\end{align*}%TODO mettre chaque terme dans un split et realigner
		\begin{align*}
		\begin{pmatrix}
			2&8
		\end{pmatrix} \circ \begin{pmatrix}
	...
	\begin{rema}
		...
		Connecter chaque \'el\'ement, compter les intersections des segments, $\mathrm{sgn}(\sigma) = (-1)^\gamma$, o\`u $\gamma$ est le nombre d'intersections.
	\end{rema}
\end{document}

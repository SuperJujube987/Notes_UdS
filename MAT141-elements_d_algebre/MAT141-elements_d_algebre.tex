...
\begin{document}
	...
	\begin{rappel}~
		...
		\begin{ulist}
			\item $E^g = \{x \in E \mid g \bullet x = x\}$, \'el\'ements $g$-invariants
			\item Burnside
			\begin{ulist}
				\item $\card{\sfrac{E}{G}} = \frac{1}{\card{G}} \sum_{g \in G} \card{E^g}$
				\item $\sfrac{E}{G} = \{\text{orbites de $G$ sur $E$}\} = \{G \bullet x \mid x \in E\}$
			\end{ulist}
		\end{ulist}
	\end{rappel}
	\begin{exem}
...
\end{psmallmatrix}}} ) = \dfrac{24}{6} = 4$.
	...
	\phantomsection\chapter*{Compl\'ements/rappels}\addcontentsline{toc}{chapter}{Compl\'ements/rappels}\renewcommand{\leftmark}{Compl\'ements/rappels}

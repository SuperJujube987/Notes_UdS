...
\begin{document}
	...
	\begin{rema}
		...
		Connecter chaque \'el\'ement, compter les intersections des segments, $\mathrm{sgn}(\sigma) = (-1)^\gamma$, o\`u $\gamma$ est le nombre d'intersections. Ici, $\mathrm{sgn}(\sigma) = (-1)^8 = 1$.
	\end{rema}

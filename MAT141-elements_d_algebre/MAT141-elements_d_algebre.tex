...
\usepackage{dsfont}
\usepackage{tikz}
\usetikzlibrary{tikzmark, calc, positioning, arrows.meta, shapes.geometric}
\usepackage{hyperref}
...
\begin{document}
	...
	\begin{exem}~
		...
		\begin{ulist}
			...
			\begin{center}
				...
				\end{tikzpicture}
			\end{center}
			$\sfrac{\entiers_{10}}{5\entiers_{10}} =$ \{\textcolor{col1}{$\blacksquare$}, \textcolor{col2}{$\blacksquare$}, \textcolor{col3}{$\blacksquare$}, \textcolor{col4}{$\blacksquare$}, \textcolor{col5}{$\blacksquare$}\}.
	...
	\begin{center}
		\begin{tikzpicture}
			...
			\path[arrows=-{Stealth[length=3mm]}] (1) edge (t) (2) edge (t) (3) edge (c) (4) edge (c) (5) edge (c) (6) edge (x);
		\end{tikzpicture}
	\end{center}

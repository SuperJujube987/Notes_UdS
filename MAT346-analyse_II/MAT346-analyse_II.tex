...
\newpage
	...
	\begin{defin}~
		...
		\begin{enumerate}[label=\alph*)]
			...
			\item L'\emph{erreur quadratique moyenne} est $E_n(t) = \dfrac{1}{2\pi} \dint{-\pi}{\pi}{\eps_n^2(t) dt} = \dfrac{1}{2\pi} \dint{-\pi}{\pi}{(f-g)^2(t) dt}$.

			Dans le cas d'une fonction d\'efinie sur $[a,b]$, on a
			\begin{equation*}
				E_n(t) = \dfrac{1}{T} \dint{a}{b}{(f-g)^2(t) dt}
			\end{equation*}
		\end{enumerate}
	\end{defin}
\end{document}

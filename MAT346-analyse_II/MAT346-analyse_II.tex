	...
	\begin{exem}
		...
		\begin{enumerate}
			...
			\item Sur $[0,1]$, posons $f_n(x) = \left\lbrace \begin{array}{lll}
				n^2x&\text{si}&x<\frac{1}{n}\\
				-n^x+2n&\text{si}&\frac{1}{n}<x<\frac{2}{n}\\
			...
			Cependant, $\dlim{n}{\infty}{\dint{0}{1}{f_n(x)dx}} = \dlim{n}{\infty}{\frac{bh}{2}} = \dlim{n}{\infty}{1} = 1$.%TODO ajouter dessin f_n(x)
			...
			\end{array} \right.$.%TODO ajouter dessin f_n(x)

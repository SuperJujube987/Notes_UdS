	...
	\begin{prop}~
		...
		\begin{proof}~
			...
			\begin{enumerate}[label=\roman*)]
				...
				Ainsi, $a_0 = \dfrac{1}{\sqrt{2\pi}} \langle f, \dfrac{1}{\sqrt{2\pi}} \rangle = \dfrac{1}{2\pi} \langle f,1 \rangle = \dfrac{1}{2\pi} \dint{-\pi}{\pi}{f(t) dt}$.
				\item
				\begin{align*}
				...
				Ainsi, $a_n = \dfrac{1}{\sqrt{\pi}} \langle f, \dfrac{\cos nx}{\sqrt{\pi}} \rangle = \dfrac{1}{\pi} \langle f,\cos nx \rangle = \dfrac{1}{\pi} \dint{-\pi}{\pi}{f(t) \cos nt dt}$.
				\item idem%TODO
			\end{enumerate}
		\end{proof}
	\end{prop}

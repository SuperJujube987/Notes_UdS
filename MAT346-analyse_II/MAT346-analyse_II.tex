...
\begin{document}
	...
	\begin{enumerate}
		...
		\begin{rapp}
			...
			\end{align*}
			\begin{align*}
					-\cosh^x+\sinh^2x&= \left( \dfrac{e^x+e^{-x}}{2} \right)^2 + \left( \dfrac{e^x-e^{-x}}{2} \right)^2\\
					&= -\dfrac{e^{2x}+2e^xe^{-x}+2^{-2x}}{4} + \dfrac{e^{2x}-2e^xe^{-x}+2^{-2x}}{4}\\
					&= 1
			\end{align*}

			Donc, $\sinh^2x-\cosh^2=1$.

			Alors, $1-\tanh^2x = \mathrm{sech}^2x \Rightarrow \mathrm{sech}^2x+\tanh^2x = 1$.
		\end{rapp}
	\end{enumerate}
\end{document}
